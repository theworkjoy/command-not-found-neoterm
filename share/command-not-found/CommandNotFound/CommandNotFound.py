...
dbpath = "/data/data/io.neoterm/files/usr/var/lib/command-not-found/commands.db"
...
class CommandNotFound(object):
    ...
    prefixes = (
        "/data/data/io.neoterm/files/usr/bin",
        "/data/data/io.neoterm/files/usr/local/bin",
        "/data/data/io.neoterm/files/usr/sbin",
        "/data/data/io.neoterm/files/usr/local/sbin",
        "/data/data/io.neoterm/files/usr/games")

    snap_cmd = "/data/data/io.neoterm/files/usr/bin/snap"

    output_fd = sys.stderr

    def __init__(self, data_dir="/data/data/io.neoterm/files/usr/share/command-not-found"):
    ...
    def _getSourcesList(self):
        ...
        # /data/data/io.neoterm/files/usr/share/python-apt/templates/
    ...
    def advise(self, command, ignore_installed=False):
        ...
        if not (os.path.exists("/data/data/io.neoterm/files/usr/bin/apt") or
                os.path.exists("/data/data/io.neoterm/files/usr/bin/aptitude")):
            return False
